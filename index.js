 ...
 * @author : Malvin King <https://github.com/Darksrhacking>
...
const ownerNumber = ['994406616480']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("SURYA-MD~", '');
...
console.log("CONNECTING SURYA-MD 🧬...");
...
console.log('SURYA-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ SURYA-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
if(senderNumber.includes("994406616480")){
if(isReact) return
m.react("🦋")
   }
